...
¿Existe una relación entre la satisfacción laboral y la rotación?
...
Las visualizaciones ayudarán a identificar patrones y tendencias clave en la rotación de empleados.

El mapa de calor mostrará relaciones entre múltiples variables.

El pairplot permitirá observar interacciones entre varias características en función de la rotación.
